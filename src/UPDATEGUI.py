...
class Ui_Dialog2(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(360, 10, 251, 61))  # "规则库"
        self.label.setStyleSheet("font: 16pt \"方正颜宋简体\";")
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(180, 80, 31, 21))  # "P"
        ...
        self.pushButton.setGeometry(QtCore.QRect(330, 480, 131, 41))  # "删除"
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "删除/修改规则"))
